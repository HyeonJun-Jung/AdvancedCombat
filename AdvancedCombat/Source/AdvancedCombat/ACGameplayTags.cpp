...
FACGameplayTags FACGameplayTags::GameplayTags;
...
void FACGameplayTags::InitializeNativeGameplayTags()
{
	...
	GameplayTags.Magic_State_Staff = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Magic.State.Staff"),
		FString("Staff")
	);

	GameplayTags.Magic_State_Hand = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Magic.State.Hand"),
		FString("Hand")
	);

	GameplayTags.Magic_Ice_IceBlast = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Magic.Ice.IceBlast"),
		FString("IceBlast")
	);
}