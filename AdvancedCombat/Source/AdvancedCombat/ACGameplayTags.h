...
struct FACGameplayTags
{

public:
	static const FACGameplayTags& Get() { return GameplayTags; }
	...
	// Magic State
	FGameplayTag Magic_State_Staff;
	FGameplayTag Magic_State_Hand;

	// Magic Type
	FGameplayTag Magic_Ice_IceBlast;


private:
	static FACGameplayTags GameplayTags;
};