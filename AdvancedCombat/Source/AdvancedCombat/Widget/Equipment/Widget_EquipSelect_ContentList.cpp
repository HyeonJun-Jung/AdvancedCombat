...
#include "Widget/Equipment/Widget_EquipSelect_ContentList.h"
...
void UWidget_EquipSelect_ContentList::UpdateContents(EItemCategory Category)
{
	...
	{
		const TArray<FACMagicStruct>& Magics = inventoryComp->GetMagics();
	...
	{
		const TArray<FSlotStruct>& contents = inventoryComp->GetContents(Category);
